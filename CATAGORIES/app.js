...
function but1slide(){
    document.querySelector(".artist1").style.left = "20px";
    document.querySelector(".artist1").style.top = "35px";
    document.querySelector(".artist2").style.left = "20px";
    document.querySelector(".artist2").style.top = "55px";
    document.querySelector(".artist3").style.left = "20px";
...
function but2slide(){
    document.querySelector(".artist4").style.left = "130px";
    document.querySelector(".artist4").style.top = "35px";
    document.querySelector(".artist5").style.left = "130px";
    document.querySelector(".artist5").style.top = "55px";
    document.querySelector(".artist6").style.left = "130px";
...
function but3slide(){
    document.querySelector(".artist7").style.left = "250px";
    document.querySelector(".artist7").style.top = "35px";
    document.querySelector(".artist8").style.left = "250px";
    document.querySelector(".artist8").style.top = "55px";
    document.querySelector(".artist9").style.left = "250px";
